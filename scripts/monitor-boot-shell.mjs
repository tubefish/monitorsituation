...
const BOOT_STYLE = `<style data-monitor-boot>
  ...
  @media(max-width:768px){.monitor-boot .skeleton-header{padding:8px 10px}.monitor-boot-region{min-width:0}.monitor-boot .skeleton-main{display:flex;flex-direction:column;overflow:auto}.monitor-boot .skeleton-map{height:calc(100dvh - 54px);min-height:60vh;flex:none}.monitor-boot .skeleton-grid{overflow:visible;padding:4px}.monitor-boot .skeleton-panel:first-child{height:488px;min-height:488px}html.wm-map-collapsed .monitor-boot .skeleton-map{height:auto;min-height:0}html.wm-map-collapsed .monitor-boot .skeleton-map-body{display:none}.monitor-boot-footer{display:none}}
