...
export const DEFERRED_PANEL_NATURAL_FOOTPRINTS: Readonly<Record<string, DeferredPanelShellFootprint>> = {
  cii: { rowSpan: 2 },
  cascade: { rowSpan: 2, className: 'panel-wide' },
  ...
  fx: { rowSpan: 2 },
  'gdelt-intel': { rowSpan: 2, className: 'panel-wide' },
  intel: { rowSpan: 2 },
  ...
  politics: { rowSpan: 2, className: 'panel-wide' },
  ...
  'x-intel': { rowSpan: 2 },
  'threat-timeline': { rowSpan: 2, className: 'panel-wide' },
  'trade-policy': { rowSpan: 2 },
  'ucdp-events': { rowSpan: 2, className: 'panel-wide' },
...
export class PanelLayoutManager implements AppModule {
    ...
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <div class="header" role="banner">
        ...
        <div class="header-right">
          ...
          <div id="authWidgetMount"></div>
        </div>
      </div>
      <div class="mobile-menu-overlay" id="mobileMenuOverlay"></div>
      <nav class="mobile-menu" id="mobileMenu" aria-label="Menu">
        <div class="mobile-menu-header">
          <span class="mobile-menu-title">$MONITOR</span>
          <button class="mobile-menu-close" id="mobileMenuClose" aria-label="Close menu">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
          </button>
        </div>
        <div class="mobile-menu-account">
          <div id="mobileAuthWidgetMount" hidden></div>
          <button type="button" class="mobile-auth-fallback" id="mobileAuthFallback">${t('auth.signIn')}</button>
        </div>
        ${(() => {
        const variants = [
  ...
  private async createPanels(): Promise<void> {
    ...
    this.lazyDefaultPanel('commodity-watch', () => import('@/components/CommodityWatchPanel'), 'CommodityWatchPanel');
    this.lazyDefaultPanel('monitor-market', () => import('@/components/MonitorMarketPanel'), 'MonitorMarketPanel');
    this.lazyDefaultPanel('market-heatmap', () => import('@/components/MarketHeatmapPanel'), 'MarketHeatmapPanel');
