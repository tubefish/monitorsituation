...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: '$MONITOR - Monitor the Situation',
    description: 'Real-time global situation dashboard tracking breaking news, conflicts, markets, military activity, infrastructure, and OSINT signals in one view.',
    keywords: '$MONITOR, Monitor the Situation, global situation dashboard, breaking news, geopolitical intelligence, OSINT, conflict tracking, military activity, infrastructure monitoring, market sentiment, real-time news, situation awareness',
    url: 'https://monitorsituation.xyz/',
    siteName: '$MONITOR',
    shortName: '$MONITOR',
    subject: 'Real-Time Global Situation Awareness',
