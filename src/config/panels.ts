...
const FULL_PANELS: Record<string, PanelConfig> = {
  ...
  'market-heatmap': { name: 'Market Heatmap', enabled: true, priority: 1 },
  'commodity-watch': { name: 'Commodities', enabled: true, priority: 1 },
